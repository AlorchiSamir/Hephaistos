...
<head>
    ...
    <title>Laravel</title>
    <?php echo $__env->yieldPushContent('libs'); ?>
    ...
    <link href="<?php echo asset('/vendor/sb-admin-2.min.css'); ?>" rel="stylesheet">
    ...
    <?php echo $__env->yieldPushContent('headers'); ?>
</head>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <?php echo $__env->make('components.top', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo asset('/vendor/sb-admin-2.min.js'); ?>></script>

</body>

</html>
<?php /**PATH /mnt/c/Projets/perso/hephaistos/resources/views/components/layout.blade.php ENDPATH**/ ?>